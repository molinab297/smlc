...
The intention behind this project is to create a very small, quick, and basic matrix library; and for that reason it is written in C. This library is purely written for interest in matrices/C programming (in addition for personal use) and is not intended to compete in performance with other well known C/C++ matrix libraries. 
